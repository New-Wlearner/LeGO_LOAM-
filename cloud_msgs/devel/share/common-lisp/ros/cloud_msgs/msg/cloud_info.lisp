...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<cloud_info>)))
  ...
  (cl:format cl:nil "Header header # 增加显示的可读性:增加seq; stamp; frame_id~%~%int32[] startRingIndex~%int32[] endRingIndex~%~%float32 startOrientation~%float32 endOrientation~%float32 orientationDiff~%~%bool[]    segmentedCloudGroundFlag # true - ground point, false - other points~%uint32[]  segmentedCloudColInd # point column index in range image~%float32[] segmentedCloudRange # point range ~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%# 0: no frame~%# 1: global frame~%string frame_id~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'cloud_info)))
  "Returns full string definition for message of type 'cloud_info"
  (cl:format cl:nil "Header header # 增加显示的可读性:增加seq; stamp; frame_id~%~%int32[] startRingIndex~%int32[] endRingIndex~%~%float32 startOrientation~%float32 endOrientation~%float32 orientationDiff~%~%bool[]    segmentedCloudGroundFlag # true - ground point, false - other points~%uint32[]  segmentedCloudColInd # point column index in range image~%float32[] segmentedCloudRange # point range ~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%# 0: no frame~%# 1: global frame~%string frame_id~%~%~%"))
