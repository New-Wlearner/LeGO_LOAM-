...
// 这里需要修改,订阅的激光雷达和IMU的话题
extern const string pointCloudTopic = "/rslidar_points";
extern const string imuTopic = "/imu/imu_data";

// Save pcd // todo 存储在/tmp
extern const string fileDirectory = "/home/dongxiao/catkin_ws/";
...
// 搜索关键帧位姿周围500m范围内的点
extern const float globalMapVisualizationSearchRadius = 2000.0; // key frames with in n meters will be visualized
